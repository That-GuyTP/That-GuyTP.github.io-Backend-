...
public final class Config {
    public static final int API_PORT = resolvePort();
    ...
    private static int resolvePort() {
        Integer configuredPort = envIntOrNull("LLL_API_PORT");
        if (configuredPort != null) {
            return configuredPort;
        }

        // Render and several other hosts inject PORT automatically.
        Integer platformPort = envIntOrNull("PORT");
    ...
    private static Path resolveDataDirectory() {
        ...
        return Paths.get("data", "lovelearninglangs");
    }
